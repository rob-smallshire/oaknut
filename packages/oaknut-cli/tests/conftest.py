"""Pytest bootstrap for oaknut-filesystem.
...
The deliberate sys.path manipulation trips ruff's E402 check on any
imports that follow, so those carry explicit per-line noqa comments.
"""
