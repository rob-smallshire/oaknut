...
class TestADFSCreateInMemory:
    ...
    @pytest.mark.parametrize(
        "adfs_format,expected_total_sectors,expected_total_bytes", ADFS_FORMATS
    )
    ...
    def test_default_title_is_empty(
        self, adfs_format, expected_total_sectors, expected_total_bytes
    ):
        adfs = ADFS.create(adfs_format)
        assert adfs.title == ""
...
class TestADFSCreateRoundTrip:
    ...
    def test_create_and_reopen_from_buffer(
        self, adfs_format, expected_total_sectors, expected_total_bytes
    ):
...
class TestADFSCreateFile:
    ...
    def test_create_file_and_reopen(
        self, adfs_format, expected_total_sectors, expected_total_bytes, tmp_path
    ):
